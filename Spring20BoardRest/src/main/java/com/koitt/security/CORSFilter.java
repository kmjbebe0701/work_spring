...
public class CORSFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		//허용하는 헤더의 목록을 작성
		resp.setHeader("Access-Control-Allow-Hesders", "X-Requested-With, Content-Type, Authorization,"
				+ "Origin, Accept, Access-Control-Request=-Method, Access-Control-Requset-Headers ");
